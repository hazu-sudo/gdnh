...
export const SHARE_THEMES = [
  ...
  { id: "birthday", label: "誕生日", background: "#f8dede", paper: "#fffdf9", accent: "#d84444", ink: "#49373a", muted: "#7f6d70", decoration: "ribbon", position: "corners", frame: true, bookmarkColor: "#e05151", dearStyle: "soft", wordmark: "Happy Birthday" },
  { id: "celebration", label: "お祝い", background: "#fae2d2", paper: "#fffdf9", accent: "#e56c28", ink: "#473b34", muted: "#807269", decoration: "star", position: "corners", frame: true, bookmarkColor: "#ef7935", dearStyle: "standard", wordmark: "Anniversary" },
